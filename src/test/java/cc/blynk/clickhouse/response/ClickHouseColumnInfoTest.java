...
public class ClickHouseColumnInfoTest {
    ...
    public Object[][] provideRegularParsingTestData() {
        return new Object[][]{
                ...
                {"DateTime('Europe/Berlin')",
                        ClickHouseDataType.DateTime, null, false, false, 19, 0,
                        TimeZone.getTimeZone("Europe/Berlin"), 0},
                {"DateTime(Europe/Amsterdam)",
                        ClickHouseDataType.DateTime, null, false, false, 19, 0,
                        TimeZone.getTimeZone("Europe/Amsterdam"), 0},
                {"FixedString(42)",
    ...
    public void testCleanTypeName() {
        ...
        assertEquals(
                ...
                "Array(Decimal(12,3))");
        assertEquals(
                ClickHouseColumnInfo.parse("Array(Array(LowCardinality(Nullable(Decimal(12,3)))))",
                                           "col").getCleanTypeName(),
