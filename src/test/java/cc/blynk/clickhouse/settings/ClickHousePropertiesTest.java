...
public class ClickHousePropertiesTest {
    ...
    /**
     * Method {@link ClickhouseJdbcUrlParser#parseUriQueryPart(URI, Properties)} returns instance
    ...
    public void additionalParametersTestClickhouseDatasource() {
        ...
        AssertJUnit.assertEquals("root", clickHouseDataSource.getProperties().getUser());
    }
